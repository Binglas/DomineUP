...
public class ComServer {
    ...
    /**
     * Este é o metodo responsável por informar o cliente se o login foi
     * realizado ou não com sucesso, sendo enviada para o cliente uma mensagem.
     *
     * @param msg
    ...
    /**
     * Este é o metodo responsável por informar o cliente se o login como guest
     * foi realizado ou não com sucesso, sendo enviada para o cliente uma
     * mensagem.
     *
     * @param msg
     * @return true se for bem sucedido, caso contrário false.
    ...
    /**
     * Este é o metodo responsável por informar o cliente se o logout foi
     * realizado ou não com sucesso, sendo enviada para o cliente uma mensagem.
     *
     * @param msg
     * @return true se for bem sucedido, caso contrário false.
    ...
    /**
     * Este método recebe a mensagem do utilizador procede ao inicio do registo
     * do utilizador. É enviada uma mensagem ao cliente com o resultado da
     * operação.
     *
    ...
    /**
     * Este método recebe a mensagem do utilizador e procede à alteração dos
     * dados pessoais. É enviada uma mensagem ao cliente com o resultado da
     * operação.
     *
     * @param msg é a mensagem recebida do cliente
     * @return true se for bem sucedido, false se ocorrer algum erro.
    ...
    /**
     * Este método recebe a mensagem do utilizador e procede à recuperação da
     * password. É enviada uma mensagem ao cliente com o resultado da operação
     * juntamente com a password.
     *
     * @param msg é a mensagem recebida do cliente
     * @return true se for bem sucedido, false se ocorrer algum erro.
     */
     ...
     * método createRoom da classe ServerState. É enviada uma mensagem ao
     * cliente que depende do decorrer da criação da sala.
     *
     * @param msg é a mensagem recebida do cliente
    ...
    /**
     * Este método descodifica os argumentos enviados pelo cliente e chama o
     * método roomChat da classe ServerUtils.
     *
     * @param msg é a mensagem recebida do cliente
    ...
    /**
     * Este método descodifica os argumentos enviados pelo cliente e chama o
     * método leaveRoom da classe ServerState. É enviada uma mensagem ao cliente
    ...
    /**
     * Este método descodifica os argumentos enviados pelo cliente e chama o
     * método joinRoom da classe ServerState. É enviada uma mensagem ao cliente
    ...
    /**
     * Este é o metodo responsável por informar o cliente se o conviete enviado
     * foi realizado ou não com sucesso, sendo enviada para o cliente uma
     * mensagem.
     *
     * @param msg
    ...
    /**
     * Este metodo envia para o cliente uma lista de objectos com todos os ranks
     * dos utilizadores.
     *
     * @return True se enviar, False se não enviar.
     */
    ...
    /**
     * Este metodo envia para o cliente uma lista de objectos com toda a
     * publicidade
     *
     * @return True se enviar, False se não enviar.
     */
